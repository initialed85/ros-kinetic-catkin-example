...
#ifndef _EXAMPLE_PUBSUBTYPES_H_
#define _EXAMPLE_PUBSUBTYPES_H_
...
#error Generated Example is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
